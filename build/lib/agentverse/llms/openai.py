...
try:
    ...
    #     openai.proxy = os.environ.get("HTTP_PROXY")
    if os.environ.get("OPENAI_API_KEY_zhizengzeng") != None:
        openai.api_base = os.environ.get("OPENAI_API_BASE_zhizengzeng")
        openai.api_key = os.environ.get("OPENAI_API_KEY_zhizengzeng")
...
@llm_registry.register("gpt-3.5-turbo-0125")
